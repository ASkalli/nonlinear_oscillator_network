...
for s in range(stats):
    for n_neurons in N_neurons_vec:
     #Initialize RNN
        ...
        PEPG_optimizer = PEPG_opt(N_dim, pop_size = 100, learning_rate=0.01, starting_mu=init_pos ,starting_sigma=1e-1)
...
with open('PEPG_test_30neurons_3layers.pkl', 'wb') as f:
