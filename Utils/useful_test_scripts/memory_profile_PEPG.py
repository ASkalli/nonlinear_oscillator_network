...
# Config
# -------------------------------
N_dim = 4045             # adjust as needed
dtype = np.float32         # switch to np.float64 to compare
...
for _ in range(n_loops):
    coordinates = PEPG_optimizer.ask()     # typically returns population samples (pop_size x N_dim)
    # ... evaluate your objective here to fill 'rewards' ...
    PEPG_optimizer.tell(rewards)

    # If you're measuring "just one update", don't keep references:
    # del coordinates
    gc.collect()
